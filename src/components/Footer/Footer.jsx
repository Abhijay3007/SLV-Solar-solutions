      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="flex flex-col space-y-4">
            <Link to="/" onClick={handleScrollToTop} className="inline-block group">
              <div className="bg-white p-2 rounded-2xl border border-white/20 shadow-md inline-block group-hover:scale-105 transition-transform">
                <img src={slvLogo} alt="SLV Solar Solutions Logo" className="h-12 w-auto object-contain rounded-lg" />
              </div>
            </Link>
            ...
            <div className="pt-2 flex items-center space-x-3">
              <a
                ...
                className="p-2 text-slate-400 hover:text-secondary bg-white/5 rounded-lg border border-white/10 hover:border-secondary/40 transition-colors"
              >
            ...
            <ul className="space-y-3 pt-1">
              ...
              <li className="flex items-start space-x-3">
                ...
                <div className="text-sm">
                  ...
                  <a href={BUSINESS_INFO.phoneTel} className="text-slate-300 hover:text-secondary hover:underline transition-all">
              ...
              <li className="flex items-start space-x-3">
                ...
                <div className="text-sm">
                  ...
                  <a href={BUSINESS_INFO.emailMailto} className="text-slate-300 hover:text-secondary hover:underline transition-all break-all">
                    {BUSINESS_INFO.email}
                  </a>
                </div>
              </li>
